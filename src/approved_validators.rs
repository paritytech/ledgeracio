...
// TODO: I associate "ACL" with "Access Control List" but that can't be what's inteded here. Can we find a better name?
pub(crate) enum ACL {
    /// Upload a new approved validator list.  This list must be signed.
    Upload { path: PathBuf },
    /// Set the validator list public signing key.  This will fail if a signing key has
    /// already been set.
    SetKey {
    ...
    /// Get the validator list public signing key.  This will fail unless a signing key
    /// has been set.
    GetKey,
    ...
    ///
    // TODO: is it true that the signing user can use any ed25519 key if they prefer, generated however the user wants?
